...
import com.example.wonder.bean.LoginBean
import com.example.wonder.bean.RegisterBean
import com.example.wonder.bean.SendVerificationCodeBean
...
class LoginViewModel : ViewModel() {
     ...
     * 发送验证码
     */
    fun sendVerificationCodeRequest(phone: String, context: Context) {
        isNet(context) {
            viewModelScope.launch {
                sendVerificationCodeLiveData.value =
                    ApiRepository().sendVerificationCodeRequest(phone)
            }
        }
    }
    ...
    fun startCountDown(
        ...
        sendVerificationCodeRequest(phoneEdit.value!!, context)
    }
